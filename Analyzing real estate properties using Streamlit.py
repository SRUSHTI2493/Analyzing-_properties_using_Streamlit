# Modules:
import numpy as np # NumPy is working with arrays,o linear algebra, fourier transform, and matrices
import pandas as pd # working with data sets for analyzing, cleaning, exploring, and manipulating data. 
